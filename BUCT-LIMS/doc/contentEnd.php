                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="nav">
                            ...
                            <li><a href="contentEnd.php"  class="menu-top-active">已结束</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
for ($i=0;$i<count($res);$i++) {
    $row = $res[$i];
    echo "<tr class='gradeX'><td><a href='contestRegProEndInfo.php?comp_id={$row['comp_id']}'>{$row['comp_id']}</td><td>{$row['comp_name']}</td><td>{$row['comp_end']}</td><td>{$row['comp_type']}</td><td>已结束</td>
</tr>";
}
