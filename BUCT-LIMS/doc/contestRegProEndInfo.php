...
if(!empty($_GET['comp_id'])){
    ...
    $resCompStatus=$comp_tb_serv->getCompStatusByCompId($_GET['comp_id']);
}
?>
                            ...
                            <p>
                                <?php
                                    echo "<a href='../control/contestRegProEndInfoDown.php?comp_id={$_GET['comp_id']}' class='btn btn-primary btn-sm'>详情请下载附件</a>";
                                ?>

                                &nbsp;&nbsp;
                                <?php
                                    if(isset($resCompStatus)&&$resCompStatus[0]['comp_status']==1) {
                                        echo "<a href='../doc/contestRegJoin.php?comp_id={$_GET['comp_id']}' class='btn btn-info btn-sm'>报名</a>";
                                    }
                                ?>
                            </p>
                        </div>
