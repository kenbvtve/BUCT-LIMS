...
if (isset($_SESSION['compManageCompEndProcess_err'])){
    switch ($_SESSION['compManageCompEndProcess_err']){
        case 1:
    ...
    unset($_SESSION['compManageCompEndProcess_err']);
}
?>
<!-- MENU SECTION END-->
            ...
            <div class="col-md-3" id="loginOptions">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="nav">
                            <li><a href="compManageCompRegister.php">报名中</a></li>
                            <li><a href="compManageCompProcess.php">进行中</a></li>
                            <li><a href="compManageCompEnd.php"  class="menu-top-active">已结束</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                if(isset($_SESSION['login_userType'])&&$_SESSION['login_userType']==1){
                                    ...
                                    $res=$comp_tb_serv->getCompList(3);
...
<td>{$row['comp_name']}</td><td>{$row['comp_type']}</td><td>{$row['comp_end']}</td><td><a onclick=\"return confirm('确认删除？');\" href='../control/compManageCompEndProcess.php?flag=1&comp_id={$row['comp_id']}' class='btn btn-danger btn-xs'>删除</a></tr>";
                                    }
                                }
                                else{
