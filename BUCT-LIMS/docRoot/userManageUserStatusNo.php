...
if (isset($_SESSION['userManageUserStatusNoProcess_err'])){
    switch ($_SESSION['userManageUserStatusNoProcess_err']){
        case 1:case 3:
    ...
    unset($_SESSION['userManageUserStatusNoProcess_err']);
}
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="nav">
                            ...
                            <li><a href="userManageUserStatusNo.php" class="menu-top-active">被拒绝用户</a></li>
            ...
            <div class="col-md-9">
                <!--   Kitchen Sink -->
                <div class="panel panel-default">
                    <div class="panel-heading">审核通过用户</div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                if (isset($_SESSION['login_userType'])&&$_SESSION['login_userType']==1){
                                    ...
                                    $res=$user_tb_serv->getUserListWaitExamByUserStatus(3);
                                    ...
                                    for ($i=0;$i<count($res);$i++) {
                                        ...
                                        echo "<tr class='gradeX'><td>$j</td><td>{$row['user_id']}</td><td>$userType</td><td>{$row['user_name']}</td><td>{$row['user_college']}</td></td><td><a onclick=\"return confirm('确认删除？');\" href='../control/userManageUserStatusNoProcess.php?flag=1&user_id={$row['user_id']}' class='btn btn-danger btn-xs'>删除</a>&nbsp;<a  onclick=\"return confirm('确认启用？');\" href='../control/userManageUserStatusNoProcess.php?flag=2&user_id={$row['user_id']}' class='btn btn-primary btn-xs'>启用</a></td></tr>";
                                    }
                                }
                                else{
