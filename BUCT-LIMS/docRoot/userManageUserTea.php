...
if (isset($_SESSION['userManageUserTea_err'])){
    switch ($_SESSION['userManageUserTea_err']){
        case 1:
    ...
    unset($_SESSION['userManageUserTea_err']);
}
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="nav">
                            ...
                            <li><a href="userManageUserTea.php" class="menu-top-active">老师用户</a></li>
            ...
            <div class="col-md-9">
                <!--   Kitchen Sink -->
                <div class="panel panel-default">
                    <div class="panel-heading">老师用户</div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                if (isset($_SESSION['login_userType'])&&$_SESSION['login_userType']==1){
                                    ...
                                    $res=$user_tb_serv->getUserListByType(2);

                                    for ($i=0;$i<count($res);$i++) {
                                        $row = $res[$i];
                                        $j=$i+1;
                                        echo "<tr class='gradeX'><td>$j</td><td>{$row['user_id']}</td><td>{$row['user_name']}</td><td>{$row['user_college']}</td></td><td><a onclick=\"return confirm('确认升级为管理员权限？')\" class='btn btn-info btn-xs' href='../control/userManageUserTeaProcess.php?flag=1&user_id={$row['user_id']}'>管理员权限</a></td></tr>";
                                    }
                                }
                                else{
