    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="nav">
                            ...
                            <li><a href="userManageUserStu.php" class="menu-top-active">学生用户</a></li>
            ...
            <div class="col-md-9">
                <!--   Kitchen Sink -->
                <div class="panel panel-default">
                    <div class="panel-heading">学生用户</div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                if (isset($_SESSION['login_userType'])&&$_SESSION['login_userType']==1){
                                    ...
                                    $res=$user_tb_serv->getUserListByType(3);

                                    for ($i=0;$i<count($res);$i++) {
                                        $row = $res[$i];
                                        $j=$i+1;
                                        echo "<tr class='gradeX'><td>$j</td><td>{$row['user_id']}</td><td>{$row['user_name']}</td><td>{$row['user_college']}</td></td><td></td></tr>";
                                    }
                                }
                                else{
