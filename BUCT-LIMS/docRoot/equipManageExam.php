...
if (isset($_SESSION['equipManageExamequipReserve_err'])){
    switch ($_SESSION['equipManageExamequipReserve_err']){
        case 1:case 3:
    ...
    unset($_SESSION['equipManageExamequipReserve_err']);
}
?>
<!-- MENU SECTION END-->
<div class="content-wrapper">
    <div class="container">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">设备预约审核</h4>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                if (isset($_SESSION['login_userType'])&&$_SESSION['login_userType']==1){
                                    ...
                                    $res=$equipreserve_tb_serv->getEquipReserveListByEquipReserveStatus(1);
...
<td><a onclick=\"return confirm('确认拒绝？');\" href='../control/equipManageExamequipReserveProcess.php?flag=1&equipreserve_id={$row['equipreserve_id']}' class='btn btn-default btn-xs'>拒绝</a>&nbsp;<a  onclick=\"return confirm('确认同意？');\" href='../control/equipManageExamequipReserveProcess.php?flag=2&equipreserve_id={$row['equipreserve_id']}' class='btn btn-info btn-xs'>同意</a></td></tr>";
                                    }
                                }
                                else{
